export const projects = [
    {
        ...
        desc:"A web application to track upcoming concert of artists. Concerts data fetched from Jambase API, Artists data scrapped using puppeteer and stored inside MongoDB",
        tags : ["Next.js", "React.js", "Tailwind", "Typescript", "API", "MongoDB", "Web Scrapping"],
